...
void sendValueAsThree7bitBytes(unsigned long value)
{
  Serial.print(value & B01111111, BYTE); // LSB
  Serial.print(value >> 7 & B01111111, BYTE); // MSB
  Serial.print(value >> 14 & B01111111, BYTE); // MSB
}

void sendValueAsFour7bitBytes(unsigned long value)
{
  Serial.print(value & B01111111, BYTE); // LSB
  Serial.print(value >> 7 & B01111111, BYTE); // MSB
  Serial.print(value >> 14 & B01111111, BYTE); // MSB
...
//          sendValueAsThree7bitBytes(currentMillis);
          sendValueAsFour7bitBytes(micros());
        }
      }
    }
//  }
