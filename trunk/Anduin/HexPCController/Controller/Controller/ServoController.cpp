...
#define CFEMURHORNOFFSET1(LEGI)  (cFemurHornOffset1)
	...
	static const short cTarsHornOffset1[] = {cRRTarsHornOffset1,  cRMTarsHornOffset1,  cRFTarsHornOffset1,  cLRTarsHornOffset1,  cLMTarsHornOffset1,  cLFTarsHornOffset1};
...
#define CTARSHORNOFFSET1(LEGI)  cTarsHornOffset1
	...
	//Min / imax values
	const short cCoxaMin1[] = {cRRCoxaMin1,  cRMCoxaMin1,  cRFCoxaMin1,  cLRCoxaMin1,  cLMCoxaMin1,  cLFCoxaMin1};
	const short cCoxaMax1[] = {cRRCoxaMax1,  cRMCoxaMax1,  cRFCoxaMax1,  cLRCoxaMax1,  cLMCoxaMax1,  cLFCoxaMax1};
	const short cFemurMin1[] ={cRRFemurMin1, cRMFemurMin1, cRFFemurMin1, cLRFemurMin1, cLMFemurMin1, cLFFemurMin1};
	const short cFemurMax1[] ={cRRFemurMax1, cRMFemurMax1, cRFFemurMax1, cLRFemurMax1, cLMFemurMax1, cLFFemurMax1};
	const short cTibiaMin1[] ={cRRTibiaMin1, cRMTibiaMin1, cRFTibiaMin1, cLRTibiaMin1, cLMTibiaMin1, cLFTibiaMin1};
	const short cTibiaMax1[] = {cRRTibiaMax1, cRMTibiaMax1, cRFTibiaMax1, cLRTibiaMax1, cLMTibiaMax1, cLFTibiaMax1};

#ifdef c4DOF
	const short cTarsMin1[] = {cRRTarsMin1, cRMTarsMin1, cRFTarsMin1, cLRTarsMin1, cLMTarsMin1, cLFTarsMin1};
	const short cTarsMax1[] = {cRRTarsMax1, cRMTarsMax1, cRFTarsMax1, cLRTarsMax1, cLMTarsMax1, cLFTarsMax1};
#endif
...
#ifdef c4DOF
	const byte cTarsLength[] = {cRRTarsLength, cRMTarsLength, cRFTarsLength, cLRTarsLength, cLMTarsLength, cLFTarsLength};
#endif
...
InputController& ServoController::ctrl()
{
...
boolean TerminalMonitor(void)
{
	if(g_fShowDebugPrompt)
	{
		...
		//DBGSerial.println("before");
		while(DBGSerial.read() != 97) delay(100);
		//DBGSerial.println("after");
		g_InControlState.fHexOn = true;
	}
	else
	{
	...
	//				g_InControlState.SelectedLeg = 255;
	//				g_InControlState.fHexOn = 0;
	//				DBGSerial.println("Robot stopped");
	//			} else {
	//				//Turn on
	//				g_InControlState.fHexOn = 1;
	//				DBGSerial.println("Robot started");
	//			}
	//#ifdef OPT_FIND_SERVO_OFFSETS
