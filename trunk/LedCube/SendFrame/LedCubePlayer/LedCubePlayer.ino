...
void loop()
{
  static const unsigned long m_frameInterval_mcs = 16667/*16667*/;
...
void receiveData()
{
  ...
  static boolean isReceivingFrame = false;

  if(!isReceivingFrame)
  {
    //            Serial.println("!isReceivingFrame");
...
//        			Serial.println("magic received");
  ...
  if(isReceivingFrame && Serial.available() > 0)
  {
    //          Serial.println("isReceivingFrame");
