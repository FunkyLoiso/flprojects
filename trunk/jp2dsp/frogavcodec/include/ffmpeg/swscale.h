...
extern "C" struct SwsContext *sws_getContext(int srcW, int srcH, int srcFormat, int dstW, int dstH, int dstFormat, int flags,
                                  SwsFilter *srcFilter, SwsFilter *dstFilter, double *param);
extern "C" int sws_scale(struct SwsContext *context, uint8_t* src[], int srcStride[], int srcSliceY,
