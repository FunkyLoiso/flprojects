 ...
 * @return 0 if OK. AVERROR_xxx otherwise.
 */
extern "C" int av_open_input_file(AVFormatContext **ic_ptr, const char *filename,
                       AVInputFormat *fmt,
                       int buf_size,
                       AVFormatParameters *ap);
 ...
 */
extern "C" int av_find_stream_info(AVFormatContext *ic);
 ...
 * @param s media file handle
 */
extern "C" void av_close_input_file(AVFormatContext *s);
...
extern "C" void dump_format(AVFormatContext *ic,
                 int index,
                 const char *url,
                 int is_output);
